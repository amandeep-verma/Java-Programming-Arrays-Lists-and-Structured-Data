...
public class GladLibMap {
    ...
    public void makeStory(){
        ...
        printOut(story, 60);
        System.out.println("\n");
        System.out.println("total replaced = "+ totalreplaced);
        System.out.println("total number of words that were possible to pick from "+ totalWordsInMap());
        System.out.println("total words actually considered "+ totalWordsConsidered());
